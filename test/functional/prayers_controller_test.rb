...
class PrayersControllerTest < ActionController::TestCase
  ...
  test "should create prayer" do
    assert_difference('Prayer.count') do
      post :create, prayer: { content: @prayer.content, credit_to: @prayer.credit_to, remarks: @prayer.remarks, title: @prayer.title }
    end
  ...
  test "should update prayer" do
    put :update, id: @prayer, prayer: { content: @prayer.content, credit_to: @prayer.credit_to, remarks: @prayer.remarks, title: @prayer.title }
    assert_redirected_to prayer_path(assigns(:prayer))
  end
